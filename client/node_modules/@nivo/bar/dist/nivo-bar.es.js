...
import { computeScale, scalePropType } from '@nivo/scales';
...
var generateGroupedBars = function generateGroupedBars(_ref4) {
  var data = _ref4.data,
      ...
      props = _objectWithoutProperties(_ref4, ["data", "layout", "keys", "minValue", "maxValue", "reverse", "width", "height", "padding", "innerPadding", "valueScale"]);
  var _ref5 = layout === 'vertical' ? ['y', [0, width]] : ['x', [height, 0]],
      _ref6 = _slicedToArray(_ref5, 2),
      axis = _ref6[0],
      range = _ref6[1];
  var indexedScale = getIndexedScale(data, props.getIndex, range, padding);
  ...
  var _ref7 = layout === 'vertical' ? [indexedScale, scale] : [scale, indexedScale],
      _ref8 = _slicedToArray(_ref7, 2),
      xScale = _ref8[0],
      yScale = _ref8[1];
  var bandwidth = (indexedScale.bandwidth() - innerPadding * (keys.length - 1)) / keys.length;
...
var generateStackedBars = function generateStackedBars(_ref3) {
  var data = _ref3.data,
      ...
      props = _objectWithoutProperties(_ref3, ["data", "keys", "layout", "minValue", "maxValue", "reverse", "width", "height", "padding", "valueScale"]);
  ...
  var _ref6 = layout === 'vertical' ? [indexedScale, scale] : [scale, indexedScale],
      _ref7 = _slicedToArray(_ref6, 2),
      xScale = _ref7[0],
      yScale = _ref7[1];
  var innerPadding = props.innerPadding > 0 ? props.innerPadding : 0;
  var bandwidth = indexedScale.bandwidth();
  var params = [_objectSpread2(_objectSpread2({}, props), {}, {
    innerPadding: innerPadding,
